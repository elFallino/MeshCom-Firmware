...
void deliver_scaffold()
{
    ...
    web_client.printf("</div><div id=\"head_layer\"><p class=\"font-small\">Meshcom 4.0 %s%s</p><p class=\"font-bold\">%s</p></div></div>", SOURCE_VERSION, SOURCE_VERSION_SUB, meshcom_settings.node_call);
